  ...
  return (
    <div >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-5">
        {[
          { icon: Scissors,     label: 'Total Team Tasks', value: devUserTasks.reduce((sum, u) => sum + u.total, 0),                               color: '#4C259A' },
          { icon: Users,      label: 'Team Members',     value: devUserTasks.length,                        color: '#e5a23a' },
          { icon: Camera,  label: 'My Completion',    value: `${completionRate}%`,                       color: '#b7d333' },
