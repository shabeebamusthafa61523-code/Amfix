  ...
  return (
    <div className="min-h-screen py-12 flex items-center justify-center p-6 bg-slate-50 dark:bg-[#0b0c10] transition-colors duration-500 relative">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-5xl">
        <div className="bg-white dark:bg-slate-900 p-10 rounded-2xl border border-[#1f6d85] dark:border-[#35216b] shadow-xl transition-colors">
...
/>                <input 
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-2xl py-3 pl-12 pr-12 text-slate-900 dark:text-slate-100 outline-none focus:border-[#1f6d85] focus:ring-2 focus:ring-[#1f6d85] transition-all peer" 
  ...
  <select
    ...
    onChange={handleChange}
    className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-2xl py-3 pl-12 text-slate-900 dark:text-slate-100 outline-none appearance-none focus:border-[#1f6d85] focus:ring-2 focus:ring-[#1f6d85] transition-all cursor-pointer"
  >
    {roles.map(r => (
        ...
        {r.name.toUpperCase()}
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <select 
                  name="designation_id" 
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-2xl py-3 pl-12 text-slate-900 dark:text-slate-100 outline-none appearance-none focus:border-[#1f6d85] focus:ring-2 focus:ring-[#1f6d85] transition-all cursor-pointer peer" 
                  onChange={handleChange} 
...
<ShieldPlus
  ...
  size={16}
/>                <select name="identityType" className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-2xl py-3 pl-12 text-slate-900 dark:text-slate-100 outline-none appearance-none focus:border-[#1f6d85] focus:ring-2 focus:ring-[#1f6d85] transition-all cursor-pointer peer" onChange={handleChange} value={formData.identityType}>
...
/>                <textarea required name="address" rows="2" className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-2xl py-3 pl-12 text-slate-900 dark:text-slate-100 outline-none focus:border-[#1f6d85] focus:ring-2 focus:ring-[#1f6d85] transition-all peer" onChange={handleChange} value={formData.address}></textarea>
            ...
            <button 
              ...
              className="lg:col-span-3 w-full py-4 bg-[#1f6d85] hover:bg-[#35216b] text-white rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-[#1f6d85]/20 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-4"
            >
              {isSubmitting ? (
                <>
